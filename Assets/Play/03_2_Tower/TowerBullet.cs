...
public class TowerBullet : MonoBehaviour
{
    ...
    private readonly float bulletSpeed = 7.5f;

    private void OnTriggerEnter(Collider other)
    {
        if (gameObject.layer == LayerMask.NameToLayer("Red_Tower_Bullet")
        ...
        if (gameObject.layer == LayerMask.NameToLayer("Blue_Tower_Bullet")
